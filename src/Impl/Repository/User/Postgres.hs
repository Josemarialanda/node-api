...
postgresGetUserByName
  :: DB.Handle -> Text -> ExceptT UserRepositoryError IO (Id User, User)
...
postgresGetUserById
  :: DB.Handle -> Id User -> ExceptT UserRepositoryError IO (Id User, User)
...
postgresDeleteUser
  :: DB.Handle -> Id User -> ExceptT UserRepositoryError IO NoContent
